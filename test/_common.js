...
var Test = (function () {
    ...
    Test.prototype.run = function (cb) {
        ...
        var exec = function () {
            ...
            assert(_this.expectations.length > 0, "No more commands expected!");            

            var expectation = _this.expectations.shift();
        ...
        this.command(task, exec, function (err) {
            ...
            assert.equal(_this.expectations.length, 0, "Did not match all expectations");
            cb();
        });
    };
