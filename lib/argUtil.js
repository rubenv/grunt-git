...
var ArgUtil = function (gruntTask, configs) {
    ...
    var options = gruntTask.options.call(gruntTask, defaultOptions);

    this.setArgValuesFromOptions(options);
};
 ...
 */
ArgUtil.prototype.setArgValuesFromOptions = function (options) {
    this.args = this.args.map(function callSetValue(arg) {
        return arg.setValueFromOptions(options);
    });
    return this;
};
